  ...
  return (
    <div className="flex flex-col gap-4">
      <Section title="ツモと打牌">
        ...
        <p>・立直後は、ツモから1秒で自動ツモ切り（その間にツモ和了・暗槓ができます）。</p>
      </Section>
      <Section title="鳴き">
      ...
      <Section title="補助ボタン">
        ...
        <p>・右クリックでツモ切り（パソコンのみ）：画面のどこでも右クリックするとツモ牌を切ります。対局画面のボタンでON/OFFできます（初期値ON、この端末に保存）。</p>
      </Section>
      <Section title="点数・終了">
        <p>・25000点持ち30000点返し、ウマ10-20、オカはトップ。最終得点は小数のまま（四捨五入しない）。</p>
        <p>・東風戦は南入あり、東南戦は西入あり。延長戦は誰かが30000点以上で終了（上限は東風戦が南4局、東南戦が西4局）。一荘戦（東南西北）は北4局で終了（延長なし）。</p>
        <p>・オーラスで親がトップかつ30000点以上なら和了止め・聴牌止め。持ち点がマイナスになったら飛び終了。</p>
        <p>・赤ドラ・喰い断は、ルーム作成時に「あり／なし」を選べます（初期値はどちらもあり）。</p>
      </Section>
      <Section title="三人麻雀">
        <p>・ルーム作成時・待機室のルールで「三人麻雀」を選べます。ルールは天鳳の段位戦3人打ちに合わせています。</p>
        <p>・二萬〜八萬を使わない108枚。ドラ表示が一萬ならドラは九萬、九萬なら一萬。赤ドラは5筒・5索の各1枚。</p>
        <p>・チーはできません。北は抜きドラ：北があるとき「抜き」ボタンで抜いて嶺上牌をツモります（ポンの直後は不可、立直中はツモった北のみ）。</p>
        <p>・抜きは鳴きと同じ扱い（一発などが消える）。抜いた北でロンできます（役満以外でも可）。北を面子で使うとオタ風。</p>
        <p>・35000点持ち40000点返し、ウマ+20/0/-20。ツモ和了はツモ損（いない1人の分は払われない）。</p>
        <p>・1場は3局（東風戦は南3局、東南戦は西3局まで延長あり）。戦績・ランキングは四人麻雀と別に集計します。</p>
      </Section>
